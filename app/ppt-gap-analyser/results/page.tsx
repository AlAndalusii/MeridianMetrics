...
function ResultsContent() {
  ...
  const handleResend = () => {
    localStorage.removeItem("ppt_gap_analyzer_lead_submitted")
    setSubmitted(false)
        ...
        <div ref={leadFormRef} className="bg-white/90 backdrop-blur-xl rounded-3xl p-8 border border-emerald-100 shadow-md">
          {submitted ? (
            <div className="text-center py-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 border-t border-emerald-100">
                <button
                ...
                <Link href="/ppt-gap-analyser" className="text-sm poppins-medium text-gray-500 hover:text-gray-700 hover:underline transition-colors flex items-center gap-1.5">
